...
module motor28BYJ48() {
	translate([0,0,19/2]) difference() {
		...
		// handle
		color("gold") translate([11,0,-16.55]) cube([4,5,6.1], center = true);
		color("gold") translate([5,0,-16.55]) cube([4,5,6.1], center = true);
		
		// screw holes
		color("gray") translate([0,17.5,-9])	cylinder(h = 2, r = 2, center = true, $fn = 32);
		color("gray") translate([0,-17.5,-9])	cylinder(h = 2, r = 2, center = true, $fn = 32);
	}
}
